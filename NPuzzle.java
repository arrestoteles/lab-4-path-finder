...
public class NPuzzle implements DirectedGraph<NPuzzle.State> {
    ...
    /**
     * Prints out the description of an NPuzzle instance.
     * @param args  the command-line arguments (the puzzle size)
     */
    public static void main(String[] args) {
        if (args.length != 1) {
            System.err.println("Usage: java NPuzzle puzzle-size");
            System.err.println("  where puzzle-size is between 0 and 6");
            System.exit(1);
        }

        System.out.println(new NPuzzle(Integer.parseInt(args[0])));
    }
